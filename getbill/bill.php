...
$pdf->Cell(0,10,'EDBMS BILL',1,0,'C');
$pdf->SetFont('','U');
$pdf->SetFont('');
$pdf->ln('20');
...
$header = array('Name','Amount');
$pdf->SetFont('Arial','',14);
$data=array(array('Currrent bill',($amount==0)?0:$amount),array('Pending Bill',$pamount),array('Total Bill',$tamount));
